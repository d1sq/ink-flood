...
export const ECHO_TABLE: { d6: number; text: string; where: string }[] = [
  ...
  { d6: 2, text: 'Горожанин на площади начинает фразу, которую Игрит слышала в прошлом цикле — слово в слово. Замолкает на полуслове. Смотрит на свои руки. Уходит.', where: 'Площадь, любое время' },
  { d6: 3, text: 'Гатс замечает «тень» Келя на площади ДО казни — мальчишка стоит у фонтана, смотрит на эшафот. Если подойти — никого нет. Другие не видят.', where: 'Площадь, 09:00–09:30' },
  ...
  { d6: 6, text: 'Оззи слышит, как кто-то в толпе тихо произносит слово «Сиверн». Обернуться — никого. Но прожилки на руках потеплели.', where: 'Любая толпа, день' },
];
